...
class SlideService:
    ...
    def generate_slide(self, title: str, content: str, duration: int, purpose: str, output_file_name: str, template: str):
        """
    ...
    def get_slide_session_ids_by_username(self, username: str):
        """
