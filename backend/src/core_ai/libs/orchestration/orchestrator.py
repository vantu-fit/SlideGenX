...
Managcore_ai.libs.es the overall process of generating presentations using multiple agents.
"""
...
# from models.slide_models import SlideContent

from core_ai.libs.agents.outline_agent.agent import OutlineAgent
from core_ai.libs.agents.outline_agent.evaluation import evaluate_outline_responses

from core_ai.libs.agents.slide_content_agent.agent import SlideContentAgent
from core_ai.libs.agents.slide_content_agent.evaluation import evaluate_slide_content_responses

from core_ai.libs.agents.image_agent.agent import ImageAgent
from core_ai.libs.agents.image_agent.evaluation import evaluate_image_responses

from core_ai.libs.agents.diagram_agent.agent import DiagramAgent
from core_ai.libs.agents.diagram_agent.evaluation import evaluate_diagram_responses

from core_ai.libs.agents.svg_diagram_agent import SVGDiagramAgent
from core_ai.libs.agents.svg_diagram_agent.evaluation import evaluate_svg_responses

from core_ai.libs.agents.slide_generator_agent.agent import SlideGeneratorAgent
from core_ai.libs.agents.slide_generator_agent.evaluation import (
...
from core_ai.libs.agents.utils import filter_slide_info

from core_ai.libs.models.slide_models import Diagram
...
class SlideGeneratorConfig:
    """Cocore_ai.libs.nfiguration for slide generator agents."""
